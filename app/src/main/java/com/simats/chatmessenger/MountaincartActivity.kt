...
class MountaincartActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mountaincart)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (coversSnapshot in snapshot.children) {
                    ...
                    if (locationData != null) {
                        ...
                        if (!imageUrl.isNullOrEmpty() && locationData.activity == "Mountain Carting" && locationData.myLocation == "Chennai") {
