...
class MountainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showMountainCovers() {
        ...
        val mountainQuery = activitiesReference.orderByChild("category").equalTo("mountains")
    ...
    private fun redirectToActivity(activityClass: Class<*>) {
        startActivity(Intent(this@MountainActivity, activityClass))
    }
}
