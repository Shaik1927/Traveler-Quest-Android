...
class RiverraftingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_riverrafting)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (coversSnapshot in snapshot.children) {
                    ...
                    if (locationData != null) {
                        ...
                        if (!imageUrl.isNullOrEmpty() && locationData.activity == "River Rafting" && locationData.myLocation == "Chennai") {
                            ...
                            Log.e("Covers", "No locations available")
                        }
                    } else {
