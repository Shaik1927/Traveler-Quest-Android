...
class HillsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showMountainCovers() {
        ...
        val mountainQuery = activitiesReference.orderByChild("category").equalTo("hills")
    ...
    private fun redirectToActivity(activityClass: Class<*>) {
        startActivity(Intent(this@HillsActivity, activityClass))
    }
}
