...
class SwampsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_swamps)
    ...
    private fun showMountainCovers() {
        ...
        val mountainQuery = activitiesReference.orderByChild("category").equalTo("Swamps")
    ...
    private fun redirectToActivity(activityClass: Class<*>) {
        startActivity(Intent(this@SwampsActivity, activityClass))
    }
}
