...
class RiversActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showMountainCovers() {
        ...
        val mountainQuery = activitiesReference.orderByChild("category").equalTo("Rivers")
    ...
    private fun redirectToActivity(activityClass: Class<*>) {
        startActivity(Intent(this@RiversActivity, activityClass))
    }
}
