...
class GlacialActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_glacial)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (coversSnapshot in snapshot.children) {
                    ...
                    if (locationData != null) {
                        ...
                        if (!imageUrl.isNullOrEmpty() && locationData.activity == "Glacial Exploration" && locationData.myLocation == "Chennai") {
