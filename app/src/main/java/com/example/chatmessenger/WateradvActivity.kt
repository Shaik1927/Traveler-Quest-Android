...
class WateradvActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_wateradv)
    ...
    private fun showMountainCovers() {
        ...
        val mountainQuery = activitiesReference.orderByChild("category").equalTo("Water Adventures")
    ...
    private fun redirectToActivity(activityClass: Class<*>) {
        startActivity(Intent(this@WateradvActivity, activityClass))
    }
}
