...
class CanyonsActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_canyons)
    ...
    private fun showMountainCovers() {
        ...
        val mountainQuery = activitiesReference.orderByChild("category").equalTo("Canyons")
    ...
    private fun redirectToActivity(activityClass: Class<*>) {
        startActivity(Intent(this@CanyonsActivity, activityClass))
    }
}
