...
class GokartingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_gokarting)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (coversSnapshot in snapshot.children) {
                    ...
                    if (locationData != null) {
                        ...
                        if (!imageUrl.isNullOrEmpty() && locationData.activity == "Go karting" && locationData.myLocation == "Chennai") {
