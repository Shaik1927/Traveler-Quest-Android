...
class MarineActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showMountainCovers() {
        ...
        val mountainQuery = activitiesReference.orderByChild("category").equalTo("Moraine")
    ...
    private fun redirectToActivity(activityClass: Class<*>) {
        startActivity(Intent(this@MarineActivity, activityClass))
    }
}
