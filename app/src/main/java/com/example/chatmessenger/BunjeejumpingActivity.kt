...
class BunjeejumpingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_bunjeejumping)
            ...
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (coversSnapshot in snapshot.children) {
                    ...
                    if (locationData != null) {
                        ...
                        if (!imageUrl.isNullOrEmpty() && locationData.activity == "Bunjee" && locationData.myLocation == "Chennai") {
                            ...
                            Log.e("Covers", "No Adventures Found in this location ")
                        }
                    } else {
