...
class LandadvActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_landadv)
    ...
    private fun showMountainCovers() {
        ...
        val mountainQuery = activitiesReference.orderByChild("category").equalTo("Land Adventures")
    ...
    private fun redirectToActivity(activityClass: Class<*>) {
        startActivity(Intent(this@LandadvActivity, activityClass))
    }
}
