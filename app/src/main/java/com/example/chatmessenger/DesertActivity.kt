...
class DesertActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showMountainCovers() {
        ...
        val mountainQuery = activitiesReference.orderByChild("category").equalTo("Desert")
    ...
    private fun redirectToActivity(activityClass: Class<*>) {
        startActivity(Intent(this@DesertActivity, activityClass))
    }
}
